...
public class MapFragmentSF extends SupportMapFragment
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        mGoogleMap.addMarker(new MarkerOptions().position(PizzaHut).title("Stir Fresh"));

        mGoogleMap.moveCamera(CameraUpdateFactory.newLatLng(PizzaHut));
